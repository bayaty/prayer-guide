                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Choose how a prayer is laid out when you open it.',
                          style: TextStyle(
                              fontSize: 13,
                              color: Colors.grey[600],
                              height: 1.4),
                        ...
                        AnimatedBuilder(
                          ...
                          builder: (context, _) {
                            ...
                            return Column(
                              children: [
                                _TextSwitch(
                                  label: 'Show every step in full',
                                  value: s.fullDetail,
                                  onChanged: s.setFullDetail,
                                ),
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border:
                                        Border.all(color: AppColors.softPink),
                                  ),
                                  child: Text(
                                    s.fullDetail
                                        ? 'Every step is written out in one '
                                            'long scroll, with its wording '
                                            'and meaning. Best while you are '
                                            'still learning.'
                                        : 'Prayers open as a short list of '
                                            'step names. Tap any step to '
                                            'read it in full. Best once you '
                                            'know the order.',
                                    style: TextStyle(
                                        fontSize: 12.5,
